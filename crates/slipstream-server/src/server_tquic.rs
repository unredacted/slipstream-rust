//! tquic-based server runtime.
//!
//! This module provides a QUIC server runtime using tquic instead of picoquic FFI.
//! It mirrors the functionality of `server.rs` but uses the slipstream-quic crate.
